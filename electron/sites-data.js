...
const BUILTIN_SITES = [
  ...
  { domain: 'amazon.ca',     code: 'CA', region: '北美', country: '加拿大',     currency: 'CAD', zipLabel: 'Postal Code',      zipExample: 'K1A 0B1',  zipFormat: '字母数字混合 (A1A 1A1)' },
  ...
  { domain: 'amazon.nl',     code: 'NL', region: '欧洲', country: '荷兰',       currency: 'EUR', zipLabel: 'Postcode',         zipExample: '1012 AB',  zipFormat: '4位数字+2字母' },
  ...
  { domain: 'amazon.com.be', code: 'BE', region: '欧洲', country: '比利时',     currency: 'EUR', zipLabel: 'Code Postal',      zipExample: '1000',     zipFormat: '4位数字' },
  { domain: 'amazon.co.jp',  code: 'JP', region: '亚太', country: '日本',       currency: 'USD', zipLabel: '郵便番号',          zipExample: '100-0001', zipFormat: '7位数字' },
  { domain: 'amazon.com.au', code: 'AU', region: '亚太', country: '澳大利亚',   currency: 'AUD', zipLabel: 'Postcode',         zipExample: '2000',     zipFormat: '4位数字' },
  ...
  { domain: 'amazon.com.mx', code: 'MX', region: '拉美', country: '墨西哥',     currency: 'MXN', zipLabel: 'Código Postal',    zipExample: '01000',    zipFormat: '5位数字' },
